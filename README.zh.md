...
Against LLM Mediocrity 研究如何对抗 LLM 的自回归平庸，并把模型的局部能力转化为稳定的任务价值。项目同时包含公开解释站点、工作论文和后续工具路线图。
...
1. 先读站点首页与“为什么重要”，理解流畅失败的日常形态。
2. 再读“机制”和主工作稿，理解三种对齐区间与四类原始错配。
3. 然后读“治理”和协作补充稿，理解控制空间、GKO、MSHQ 和 GEO。
4. 最后读“学习”和“项目”，理解人类能力与工具实现如何承接这套框架。
