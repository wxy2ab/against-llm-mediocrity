...
- 聚合失配 artifact-v13 状态漂移与 Intent rebase（归档）：[English](./docs/aggregation-mismatch-v13-state-drift-intent-rebase.md) · [中文](./docs/aggregation-mismatch-v13-state-drift-intent-rebase.zh-CN.md)：96 个正式 episodes 与 768 个离线案例的 method-development artifact；四臂均为 24/24，A1 未裁决，不进入 V1–V12 + V14 证据合成。
...
- 聚合失配 V1–V12 + V14 实验总览：[English](./docs/aggregation-mismatch-v1-v12-v14-experiment-summary.md) · [中文](./docs/aggregation-mismatch-v1-v12-v14-experiment-summary.zh-CN.md)：逐代整理已建立、未建立和不可推广的 claim，并说明为何排除已归档 V13。
- 聚合失配 V1–V12 + V14 Agent 工程经验：[English](./docs/aggregation-mismatch-agent-engineering-lessons-v1-v12-v14.md) · [中文](./docs/aggregation-mismatch-agent-engineering-lessons-v1-v12-v14.zh-CN.md)：完整汇总架构、路由、telemetry、commit、recovery、落地顺序和应用映射。
