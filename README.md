...
- **State-Governed Agent Regime (SGAR)** — An LLM-oriented state-governance and dependency-decomposition method that renders small local solving surfaces from globally authoritative state, composes stages through public protocols, and commits only verified state deltas.
...
- Scenario, prompt, and evidence router: [English](docs/guidelines/guidelines.md) · [中文](docs/guidelines/guidelines.zh-CN.md) — Selects which guide to use as the operating prompt and identifies its theoretical or experimental basis.
...
- Latent-Structure-Surface-Realization mismatch: [English](docs/candidate-seventh-mismatch-latent-structure-surface-realization.md) · [中文](docs/candidate-seventh-mismatch-latent-structure-surface-realization.zh-CN.md) — A candidate-phenomenon draft on tasks that require a complete latent structure to govern output while remaining only sparsely and temporally realized on the surface.
...
- An Agent Is Not a Longer Chat: [English](docs/agent-is-not-a-longer-chat.md) · [中文](docs/agent-is-not-a-longer-chat.zh-CN.md) — A practitioner-oriented explanation of why persistent delegation requires explicit task state, evidence, gates, commitment, and risk-proportional audit rather than a longer model loop.
- State-Governed Agent Regime for governed LLM systems: [English](docs/state-governed-agent-regime-for-governed-llm-systems.md) · [中文](docs/state-governed-agent-regime-for-governed-llm-systems.zh-CN.md) — Globally conditioned local solving, public protocols, hard-state authority, and verified commitment.
- Agent Harness Framework: [English](docs/agent-harness-framework.md) · [中文](docs/agent-harness-framework.zh-CN.md) — A runtime-science draft that separates model-conditioned capability frontier, runtime bridge, and Action-Space Optimization into quantifiable components.
- Why Agent Engineering must take controlled experiments seriously: [English](docs/why-agent-engineering-needs-controlled-experiments.md) · [中文](docs/why-agent-engineering-needs-controlled-experiments.zh-CN.md) — A frontier evidence review, critique, and six-mismatch experimental program for turning harness work into cumulative causal knowledge.
- Aggregation mismatch across scales: from single-call reasoning to agent trajectories: [English](docs/aggregation-mismatch-across-scales-from-single-call-reasoning-to-agent-trajectories.md) · [中文](docs/aggregation-mismatch-across-scales-from-single-call-reasoning-to-agent-trajectories.zh-CN.md) — A bridge manuscript that separates semantic prefix lock-in from causal path lock-in and explains when persistent Plan and Candidate provide real agent-level value.
- From fixed workflows to governed delegation: [English](docs/from-fixed-workflows-to-governed-delegation.md) · [中文](docs/from-fixed-workflows-to-governed-delegation.zh-CN.md) — The software-design bridge from predefined execution paths to runtime decisions constrained by capabilities, authority, evidence, gates, and commit rules.
...
- Aggregation mismatch artifact-v10 semantic contracts and runtime canonicalization: [English](docs/aggregation-mismatch-v10-semantic-contract-canonicalization.md) · [中文](docs/aggregation-mismatch-v10-semantic-contract-canonicalization.zh-CN.md) — The completed 64-episode plus 1,024-case study: semantic-set canonicalization passes its implementation gate, while the preregistered ≥20-point end-to-end gain fails; the result separates sound interface design from an unconfirmed performance promise.
- Aggregation mismatch artifact-v11 address drift and configuration delivery: [English](docs/aggregation-mismatch-v11-config-delivery-transfer.md) · [中文](docs/aggregation-mismatch-v11-config-delivery-transfer.zh-CN.md) — The completed 256-episode plus 1,024-case study: relocation amplifies semantic-ID over model-authored index by 21.875 points in the larger tested configs; Patch–Rewrite reliability is ceiling-limited, while Patch is substantially cheaper.
- Aggregation mismatch artifact-v12 drift dose and delivery-scale routing: [English](docs/aggregation-mismatch-v12-scale-routing-transfer.md) · [中文](docs/aggregation-mismatch-v12-scale-routing-transfer.zh-CN.md) — The completed 240-episode plus 768-case study: the drift-dose interaction fails, while sparse verified-plan Patch improves 300-second strict success over Full Rewrite by 29.17 points; Regional Rewrite remains exploratory and heterogeneous.
- Aggregation mismatch artifact-v13 state drift and Intent rebase (archived): [English](docs/aggregation-mismatch-v13-state-drift-intent-rebase.md) · [中文](docs/aggregation-mismatch-v13-state-drift-intent-rebase.zh-CN.md) — The completed 96-episode plus 768 offline method-development study: all four arms hit 24/24, so V13-A1 is not adjudicated and is excluded from the V1–V12 + V14–V17 synthesis.
- Aggregation mismatch artifact-v14 post-compile drift and Exact recovery: [English](docs/aggregation-mismatch-v14-post-compile-drift-recovery.md) · [中文](docs/aggregation-mismatch-v14-post-compile-drift-recovery.zh-CN.md) — The completed 96-episode plus 768-case study: compatible Exact is safely rejected stale and recovered 24/24; its +19.3% token-cost interaction is positive but misses the preregistered +20% gate.
- Aggregation mismatch artifact-v15 Intent conflict governance: [English](docs/aggregation-mismatch-v15-intent-conflict-governance.md) · [中文](docs/aggregation-mismatch-v15-intent-conflict-governance.zh-CN.md) — The completed 96-episode plus 768-case study: conflict first commits are rejected 0/72, governed Intent/Exact Rebase recover 48/48, and Naive terminates 0/24. The machine primary passes, but the frozen Pilot Gate differs from the executable gate, so the evidence is shared with caveats.
- Aggregation mismatch artifact-v16 matched conflict recovery: [English](docs/aggregation-mismatch-v16-matched-conflict-recovery.md) · [中文](docs/aggregation-mismatch-v16-matched-conflict-recovery.zh-CN.md) — The completed 96-episode plus 768-case study: with second-turn opportunities matched, Generic/Reread remain locked at 0/24 while runtime Unlock + Rebase reaches 24/24. The machine primary passes; bundled authority/state/information and a frozen-manifest metadata deviation require caveats.
- Aggregation mismatch artifact-v17 unlock information and escalation: [English](docs/aggregation-mismatch-v17-unlock-info-escalate.md) · [中文](docs/aggregation-mismatch-v17-unlock-info-escalate.zh-CN.md) — The completed 192-episode plus 1,536-case study: four post-unlock information arms all reach 24/24, so superiority is not established; old-state context costs 74.9% more median tokens. Typed Escalate reaches 24/24 accepted non-commit outcomes under an unresolvable lock, with the different-endpoint caveat.
- Aggregation mismatch artifacts v18/v19 Step versus Stage: [English](docs/aggregation-mismatch-v18-v19-step-vs-stage-iteration.md) · [中文](docs/aggregation-mismatch-v18-v19-step-vs-stage-iteration.zh-CN.md) — Under both revision-matched and call-matched synthetic DAG protocols, Stage strongly outperformed Step; the preregistered primary claims predicted the opposite direction, so the result remains repeated secondary evidence.
- Aggregation mismatch V20–V25 writing and Stage repair: [English](docs/aggregation-mismatch-v20-v25-writing-and-stage-repair.md) · [中文](docs/aggregation-mismatch-v20-v25-writing-and-stage-repair.zh-CN.md) — Low-load Ladder overhead, the clean V22-r6 high-load positive signal, V23S/V24 repair capacity, and the V25 inconclusive quality verdict with Phase 2 treatment-variance evidence.
- Aggregation mismatch Wave34 and cross-configuration probes: [English](docs/aggregation-mismatch-wave34-and-cross-configuration-probes.md) · [中文](docs/aggregation-mismatch-wave34-and-cross-configuration-probes.zh-CN.md) — Completed V5b/V13b/T1 and MiniMax minimum probes, with ceiling, floor, transport, and pending-human-evaluation limits kept explicit.
- Aggregation mismatch V1–V25 and supplementary experiments: [English](docs/aggregation-mismatch-v1-v25-and-supplementary-experiments.md) · [中文](docs/aggregation-mismatch-v1-v25-and-supplementary-experiments.zh-CN.md) — The current bilingual evidence synthesis, experiment ledger, claim ceiling, and agent-engineering consequences across the complete program.
- Aggregation mismatch V1–V12 + V14–V17 experiment synthesis (historical detail entry): [English](docs/aggregation-mismatch-v1-v12-v14-v17-experiment-summary.md) · [中文](docs/aggregation-mismatch-v1-v12-v14-v17-experiment-summary.zh-CN.md) — A claim-bounded map of the earlier artifacts and why archived V13 is excluded; superseded as the latest overview by the V1–V25 synthesis.
- Aggregation mismatch V1–V12 + V14–V17 agent engineering lessons (historical baseline): [English](docs/aggregation-mismatch-agent-engineering-lessons-v1-v12-v14-v17.md) · [中文](docs/aggregation-mismatch-agent-engineering-lessons-v1-v12-v14-v17.zh-CN.md) — The earlier architecture, conflict-governance, telemetry, commit, recovery, and rollout guide; the V1–V25 synthesis carries the current additions.
...
- Codex collaboration operating playbook: [English](docs/codex-collaboration-operating-playbook.md) · [中文](docs/codex-collaboration-operating-playbook.zh-CN.md) — Reusable modes for adversarial audit, executable planning, frozen evaluation, governed execution, minimal escalation, handoff, and delivery closure.
