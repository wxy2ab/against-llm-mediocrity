...
- Aggregation mismatch V1–V12 + V14–V15 experiment synthesis: [English](docs/aggregation-mismatch-v1-v12-v14-v15-experiment-summary.md) · [中文](docs/aggregation-mismatch-v1-v12-v14-v15-experiment-summary.zh-CN.md) — A claim-bounded map of what each artifact establishes, what remains unresolved, and why archived V13 is excluded.
- Aggregation mismatch V1–V12 + V14–V15 agent engineering lessons: [English](docs/aggregation-mismatch-agent-engineering-lessons-v1-v12-v14-v15.md) · [中文](docs/aggregation-mismatch-agent-engineering-lessons-v1-v12-v14-v15.zh-CN.md) — A complete architecture, conflict governance, routing, telemetry, commit, recovery, rollout, and application guide derived from the evidence chain.
