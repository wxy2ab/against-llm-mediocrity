...
**实验配套：** [Artifact-v4 实验证据、理论差距与 Agent 含义](./aggregation-mismatch-v4-claims-theory-gap.zh-CN.md) · [Artifact-v5 稳定编辑 Agent](./aggregation-mismatch-v5-stable-editing-agent.zh-CN.md) · [Artifact-v7 机制恢复与确定性交付](./aggregation-mismatch-v7-mechanism-recovery.zh-CN.md) · [Patch 与完整重写受控实验](./patch-vs-full-rewrite-controlled-experiment.zh-CN.md)
