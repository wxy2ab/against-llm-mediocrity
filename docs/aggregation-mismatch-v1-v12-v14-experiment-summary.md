# Aggregation Mismatch V1–V12 and V14: Experiment Summary
...
**中文：** [聚合失配 V1–V12 与 V14 实验总览](./aggregation-mismatch-v1-v12-v14-experiment-summary.zh-CN.md)
...
timing to genuine TOCTOU drift after payload seal.
...
## 8. Claims with relatively strong support
...
Runtime is better suited to:
  ...
  verifying, committing/rolling back, and recording events
```
...
## 11. Rules for cross-version use
