...
本规范篇幅较长，可借助下面的章节地图直接跳到所需主题。第 1–4 节给出概念框架（目的、原则、分层与生命周期）；第 5–16 节逐一定义每种受治理对象；第 17–20 节说明对象之间如何关联、实现 profile，以及如何映射回六类原始失配；第 21–27 节给出一个完整示例、失败模式、治理的成本收益与一致性；附录提供一个最小起步对象集。

- [1. 目的与范围](#1-目的与范围)
- [2. 设计原则](#2-设计原则)
- [3. 架构层](#3-架构层)
- [4. 规范对象生命周期](#4-规范对象生命周期)
- [5. 通用对象封套](#5-通用对象封套)
- [6. 受治理知识对象](#6-受治理知识对象)
- [7. 受治理执行对象](#7-受治理执行对象)
- [8. 证据对象](#8-证据对象)
...
- [15. 转移契约](#15-转移契约)
- [16. 能力路由规则](#16-能力路由规则)
- [17. 对象关系与图语义](#17-对象关系与图语义)
- [18. 核心接口](#18-核心接口)
- [19. 最小实现 Profile](#19-最小实现-profile)
- [20. 对象到原始失配的映射](#20-对象到原始失配的映射)
- [21. Text-to-SQL 实例](#21-text-to-sql-实例)
- [22. 治理失败模式](#22-治理失败模式)
- [23. 治理成本收益规则](#23-治理成本收益规则)
- [24. 审计之审计要求](#24-审计之审计要求)
- [25. 一致性 Checklist](#25-一致性-checklist)
- [26. 紧凑 JSON 类型索引](#26-紧凑-json-类型索引)
- [27. 结论](#27-结论)
