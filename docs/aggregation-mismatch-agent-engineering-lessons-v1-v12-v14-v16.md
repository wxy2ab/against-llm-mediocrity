# From Aggregation Mismatch V1–V12 and V14–V16 to Agent Engineering
...
**中文：** [从聚合失配 V1–V12、V14–V16 到 Agent 工程](./aggregation-mismatch-agent-engineering-lessons-v1-v12-v14-v16.zh-CN.md)

**Evidence companion:** [V1–V12 and V14–V16 experiment summary](./aggregation-mismatch-v1-v12-v14-v16-experiment-summary.md)
...
11. With unlock authority and \(S_2\) matched, what are the independent effects
    of receipt-only, old-state, target-slice, and structured rebase-plan context?
12. Does the V16 same-state retry result replicate on a second model and real
...
- [V1–V12 and V14–V16 experiment summary](./aggregation-mismatch-v1-v12-v14-v16-experiment-summary.md)
